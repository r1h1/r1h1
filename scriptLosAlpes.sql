...
AS
BEGIN
    OPEN reporteVentaDiaria FOR SELECT DISTINCT COUNT(PRO_TIPO) AS No, PRO_TIPO AS Tipo_De_Mueble, PRO_NOMBRE AS Nombre, CANTIDAD_COMPRAPRODUCTO AS Cantidad,
                                PRO_PRECIO AS Costo_Unitario, CARRITO_TOTAL_COMPRA AS Costo_Total, COMPRA_FECHA_COMPRA AS Fecha_Compra FROM LA_COMPRA_FACTURA
