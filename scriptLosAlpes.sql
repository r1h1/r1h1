...
AS
BEGIN
    OPEN registros FOR SELECT PRO_ID, PRO_NOMBRE, PRO_PRECIO, PRO_DESCRIPCION, PRO_RUTA_IMAGEN FROM LA_PRODUCTO;
END;
...
AS 
BEGIN
    INSERT INTO LA_COMPRA_FACTURA VALUES (AUTOINCREMENTABLE_COMPRA_FACTURA.nextval,IDCOMPRAUSUARIO,CARRITOIDPRODUCTO,
