...
AS
BEGIN
    OPEN registros FOR SELECT PRO_ID, PRO_NOMBRE, PRO_PRECIO, PRO_DESCRIPCION FROM LA_PRODUCTO;
END;
...
AS 
BEGIN
    INSERT INTO LA_CARRITO_PRODUCTOS VALUES (AUTOINCREMENTABLE_REF_CARRITO.nextval,carritoIdProducto,cantidadCompraProducto);
END;
...
AS
BEGIN
    OPEN prods FOR SELECT PRO_ID AS COD_Producto, PRO_NOMBRE AS Producto, PRO_PRECIO AS Precio, CANTIDAD_COMPRAPRODUCTO AS Cantidad FROM LA_CARRITO_PRODUCTOS
...
(
    ...
    ID_COMPRA_CARRITO INT,
    ID_COMPRA_USUARIO INT,
    COMPRA_TOTAL NUMBER NOT NULL,
