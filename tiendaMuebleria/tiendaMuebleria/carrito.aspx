                    ...
                    <div class="col-md-6 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>Tienes N articulo(s) en el carrito de compras</p>
                        ...
                        <div class="card">
                            ...
                            <span style="color: rgb(255, 0, 0); font-size: 20px;">*</span>
                                ...
                                <span style="color: rgb(255, 0, 0); font-size: 20px;">*</span>
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" class="form-control" id="fechaVencimiento" placeholder="Mes" required>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="number" class="form-control" id="fechaVencimiento" placeholder="Año" required>
                                    </div>
                                </div>
