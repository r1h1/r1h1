                                ...
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body">
                                        <div class="row">      
                                            ...
                                            <div class="mb-3">
                                                <asp:Button ID="buscarDato" runat="server" Text="Generar" class="btn btn-dark" />
                                            </div>
                                            ...
                                            <div class="mb-3" id="tablareporte" runat="server">
                                                <div class="table-responsive mt-5">
                                                    ...
                                                    <asp:Label ID="totalVentaDiariaLabel" class="form-label" runat="server" Text="Total Venta Diaria: ">
                                                        <asp:Label ID="totalVentaDiaria" class="form-label fw-bold" runat="server" Text="Q2000"></asp:Label></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
