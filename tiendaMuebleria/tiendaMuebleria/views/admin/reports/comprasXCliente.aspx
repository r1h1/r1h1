<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comprasXCliente.aspx.cs" Inherits="tiendaMuebleria.views.admin.reports.comprasXCliente" %>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1 class="m-0 pl-5 mt-4">Compras Realizadas por Cliente</h1>
                                </div>
                                <!-- /.col -->
                            </div>
                            <!-- /.row -->
                                ...
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body">
                                        <div class="row">      
                                            ...
                                            <div class="mb-3">
                                                <label for="message-text" class="col-form-label">Número de Documento del Cliente (*)</label>
                                                <asp:TextBox ID="clienteDoc" runat="server" class="form-control" placeholder="3050000040115"></asp:TextBox>
                                            ...
                                            <div class="mb-3" id="tablareporte" runat="server">
                                                <div class="table-responsive mt-4">
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col">Muebleria Los Alpes</th>
                                                                <th></th>
                                                                <th></th>
                                                                <th></th>
                                                            </tr>
                                                    ...
                                                    <div class="table-responsive mt-1 mb-4">
                                                        <asp:GridView ID="comprasXClient" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" ForeColor="Black" GridLines="Horizontal" ShowHeaderWhenEmpty="True" CellPadding="4" Width="1193px">
